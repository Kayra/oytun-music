"""
Django settings for oytun_music project.
...
SECRET_KEY = 'mkizcgwp67s#ny4x(^z30s6*3$t&v&g2jfh67+u^$3w!0(j(tg'
...
WSGI_APPLICATION = 'oytun_music.wsgi.application'
